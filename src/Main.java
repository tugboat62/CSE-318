...
public class Main {
    public static void main(String[] args) throws IOException {
        BufferedReader br = new BufferedReader(new FileReader("puzzle23.txt"));
        ...
        if (!solvable) {
            ...
            LinkedList<NodeMini> visited = new LinkedList<>();
            ...
            while (true) {
                ...
                visited.add(new NodeMini(node1.mat));
    ...
    public static void makeNodes(Node n, PriorityQueue<Node> pq, int l, LinkedList<NodeMini> visited, int choice) {
        int s = n.row;
        int t = n.column;
        if (s < l - 1) {
    ...
    public static void addNode(int i, int j, int s, int t, int l, PriorityQueue<Node> pq,
                               int choice, LinkedList<NodeMini> visited, Node parent) {
